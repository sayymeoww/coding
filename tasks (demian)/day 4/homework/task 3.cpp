...
#define     graph   vector<pair<int, int>>
#define     queue   priority_queue<node, vector<node>, greater<node>>
...
void dijkstra(int start) {
    ...
    while (!q.empty()) {
        ...
        if (!(Distances[v].first < d.first || Distances[v].second + d.second > 0)) {
